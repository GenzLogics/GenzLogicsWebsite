  ...
  return (
    <main className="bg-slate-50 text-slate-950">
      <div className="mx-auto max-w-7xl px-6 py-8 sm:px-10">
        ...
        <section className="grid gap-12 py-16 lg:grid-cols-[1.2fr_0.8fr] lg:items-center">
          <div>
            ...
            <div className="mt-8 flex flex-col gap-4 sm:flex-row sm:items-center">
              <a
                href="#contact"
                className="inline-flex items-center justify-center rounded-full bg-slate-950 px-6 py-3 text-sm font-semibold !text-white transition hover:bg-slate-800 hover:!text-white"
              >
                Start a project
              </a>
              <a
                href="#services"
                className="inline-flex items-center justify-center rounded-full border border-slate-200 px-6 py-3 text-sm font-semibold text-slate-950 transition hover:bg-slate-50"
              >
                Explore services
              </a>
            </div>
        ...
        <section
          id="approach"
          className="rounded-[2rem] border border-slate-200 bg-slate-950 px-8 py-12 text-white shadow-lg sm:px-10"
        >
          <SectionHeader
            eyebrow="Approach"
        ...
        <section id="contact" className="rounded-[2rem] border border-slate-200 bg-white px-8 py-12 shadow-sm sm:px-10">
      ...
      <a
        href="mailto:contact@genzlogics.com"
        className="fixed bottom-6 right-6 z-20 inline-flex items-center gap-2 rounded-full bg-slate-950 px-5 py-3 text-sm font-semibold !text-white shadow-xl shadow-slate-900/10 transition hover:bg-slate-800 hover:!text-white md:bottom-8 md:right-8"
      >
        Contact us
      </a>
    </main>
